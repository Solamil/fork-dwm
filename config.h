...
static const char *hibernatecmd[] = { "i3exit", "hibernate", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_m,	   spawn,	   SHCMD("pactl set-source-mute @DEFAULT_SOURCE@ toggle && kill -37 $(pidof dwmblocks)") },
